...
TGraphErrors* get1fbObs(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700,  800,  900,  1000,  1100,  1200,  1300, 1400, 1500,  1600, 1700,  1800/*,  1900,2000*/};
  Double_t yl[21]={260, 380, 380, 360, 350, 330, 280, 220,  190,  160,  140,   130,   125,   120,  120,  115,   110,  105,   100/*,  0, 0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbUp(){
  ...
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*,1900,2000*/};
  Double_t yl[21]={260, 420, 410, 400, 390, 380, 370, 320, 270, 240, 210 , 200,  200,  190,  180,  175,  170,  165,  160/*, 0, 0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbLow(){
  ...
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900,2000*/};
  Double_t yl[21]={250, 370, 350, 330, 320, 300, 220, 180, 160, 140, 120,   115, 110,   100,   100,   100,   95,   90,   90/*,  0,   0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbExp(){
  ...
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900, 2000*/};
  Double_t yl[21]={260, 380, 380, 370, 360, 350, 330, 260, 220, 180, 160,  150,  140,  140,  135,  130,  120,  120,  110/*,  0,    0*/};
  Double_t exl[21];
  Double_t eyl[21];
