...
TGraphErrors* get1fbObs(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 650, 700,  800,  900,  1000,  1100,  1200,  1300, 1400, 1500,  1600, 1700,  1800/*,  1900,2000*/};
  Double_t yl[21]={260, 425, 415, 395, 385, 380, 355, 320,  260,  220,  200,   190,   180,   175,  170,  160,   150,  150,   150/*,  0, 0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbUp(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*,1900,2000*/};
  Double_t yl[21]={270, 430, 420, 410, 400, 400, 390, 340, 290, 250, 230 , 230,  220,  210,  200,  200,  190,  190,  190/*, 0, 0*/};
...
TGraphErrors* get1fbLow(){
  ...
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900,2000*/};
  Double_t yl[21]={250, 385, 355, 340, 340, 335, 280, 240, 210, 180, 160,   150,   140,   130,   120,   110,   100,   100,   100/*,  0,   0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbExp(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900, 2000*/};
  Double_t yl[21]={260, 420, 395, 380, 380, 380, 355, 290, 257, 220, 200,  190,  175,  170,  165,  160,  160,  160,  150/*,  0,    0*/};
