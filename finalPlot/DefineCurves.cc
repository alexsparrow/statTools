...
TGraphErrors* get1fbObs(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700,  800,  900,  1000,  1100,  1200,  1300, 1400, 1500,  1600, 1700,  1800};//,  1900,2000};
  Double_t yl[21]={260, 400, 380, 350, 345, 340, 230, 195,  160,  150,  140,   135,   130,   130,  125,  125,   125,  120,   120};//,  0, 0};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbObs186(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700,  800,  900,  1000,  1100,  1200,  1300, 1400, 1500,  1600, 1700,  1800};//,  1900,2000};
  Double_t yl[21]={260, 400, 380, 345, 340, 340, 230, 195,  160,  150,  140,   135,   135,   135,  130,  130,   130,  125,   125};//,  0, 0};
  Double_t exl[21];
  Double_t eyl[21];
