...
TGraphErrors* get1fbObs(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700,  800,  900,  1000,  1100,  1200,  1300, 1400, 1500,  1600, 1700,  1800/*,  1900,2000*/};
  Double_t yl[21]={260, 410, 400, 390, 385, 380, 360, 320,  250,  220,  200,   180,   170,   160,  150,  140,   130,  120,   120/*,  0, 0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbUp(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*,1900,2000*/};
  Double_t yl[21]={260, 420, 410, 400, 400, 390, 380, 350, 290, 250, 220 , 210,  200,  190,  190,  190,  180,  180,  180/*, 0, 0*/};
...
TGraphErrors* get1fbLow(){
  ...
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900,2000*/};
  Double_t yl[21]={250, 360, 350, 340, 330, 300, 220, 190, 170, 150, 140,   130,   120,   120,   115,   110,   100,   90,   80/*,  0,   0*/};
  Double_t exl[21];
  Double_t eyl[21];
...
TGraphErrors* get1fbExp(){
  Int_t nl = 21-2;
  Double_t xl[21]={0  , 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800/*, 1900, 2000*/};
  Double_t yl[21]={260, 400, 390, 380, 370, 360, 320, 260, 220, 210, 190,  180,  170,  160,  150,  140,  130,  120,  120/*,  0,    0*/};
